...
def main():
    ...
    for name in ('evals/manifests/v4_fresh_screens_v2.jsonl', 'evals/v4-screen-nomination-v2.json', 'evals/v4-iteration-amendment-v1.json', 'evals/v4-iteration-amendment-v2.json'):
