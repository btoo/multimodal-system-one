...
parser.add_argument('--key-file',help='Private JSON credential file containing api_key; overrides the environment')
args=parser.parse_args()
print(json.dumps(run(args.provider,args.run_id,args.execute,args.max_spend_usd,args.key_file),indent=2))
