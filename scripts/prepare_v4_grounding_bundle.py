...
def main():
    ...
    for name in ['evals/v4-grounding-training-nomination-v1.json','evals/v4-grounding-confirmation-nomination-v1.json','evals/v4-native-coordinate-reference-v1.json','evals/manifests/v4_joint_regression_v1.jsonl','evals/v4-joint-regression-amendment-v1.json','evals/v4-image-ablation-protocol-v1.json']:
