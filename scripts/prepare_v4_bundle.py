...
def main():
    ...
    for name in ["mmso/backbone_adapters.py", "mmso/backbone_diagnostics.py", "mmso/parallel_decisions.py", "evals/v4-adapter-protocol-v1.json", "evals/v4-adapter-nomination-v1.json", "evals/v4-nomination-v1.json", "evals/v4-diagnostics-protocol-v1.json"]:
